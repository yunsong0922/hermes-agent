...
def _classify_400(
    ...
    *,
    ...
    # GitHub Copilot intermittently returns 400 model_not_supported for valid
    # models — treat as transient and retry (matches PR #8833 / PR #9039).
    # Scoped to Copilot only: other providers correctly signal a hard error here.
    if error_code.lower() == "model_not_supported" and provider == "copilot":
        return result_fn(
